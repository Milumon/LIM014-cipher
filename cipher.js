 const cipher = {
   ...
   encode: function (offset, string) {
     ...
     if (typeof (offset) !== 'number' || typeof (string) !== 'string' || isNaN(offset) || string == "") {  
      throw TypeError('El offset debe ser un número y el mensaje debe contener una cadena de texto');
    }  
